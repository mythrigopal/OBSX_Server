...
import org.obsplatform.billing.discountmaster.serialization.DiscountCommandFromApiJsonDeserializer;
...
public class DiscountWritePlatformServiceImpl implements
	 ...
	 * 
	 * @see
	 * #createNewDiscount(org.obsplatform.infrastructure.core.api.JsonCommand)
	 */
	@Transactional
	@Override
