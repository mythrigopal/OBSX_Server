...
public class OneTimeSaleWritePlatformServiceImpl implements OneTimeSaleWritePlatformService {
	...
	/* (non-Javadoc)
	 * @see #createOneTimeSale(org.obsplatform.infrastructure.core.api.JsonCommand, java.lang.Long)
	 */
	@Transactional
	@Override
	...
	/* (non-Javadoc)
	 * @see #calculatePrice(java.lang.Long, org.obsplatform.infrastructure.core.api.JsonQuery)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see #deleteOneTimeSale(org.obsplatform.infrastructure.core.api.JsonCommand, java.lang.Long)
	 */
	@Transactional
	@Override
