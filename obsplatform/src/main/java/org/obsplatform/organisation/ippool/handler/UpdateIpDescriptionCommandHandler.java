...
@Service
public class UpdateIpDescriptionCommandHandler implements NewCommandSourceHandler {

	private final IpPoolManagementWritePlatformService ipPoolManagementWritePlatformService;

	@Autowired
	public UpdateIpDescriptionCommandHandler(
	...
	public CommandProcessingResult processCommand(JsonCommand command) {
		...
		return this.ipPoolManagementWritePlatformService.updateIpDescription(command);
	}
}
